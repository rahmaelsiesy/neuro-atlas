...
const QUEST_DATA = {
  ...
  dlpfc: [
    {
      ...
      steps: [
        ...
        {
          id: "f-decoding-2",
          title: "Post-hoc FDR threshold sweep",
          type: "code",
        ...
        {
          id: "f-decoding-3",
          title: "Gene-stratified efficiency analysis",
          type: "code",
        ...
        {
          id: "f-decoding-4",
          title: "Matching rate computation",
          type: "code",
        ...
        {
          id: "f-decoding-5",
          title: "Publication-ready QC figures",
          type: "figure",
...

    {
      ...
      steps: [
        { id: "f-seg-1", title: "Segmentation overlap with DAPI", type: "code",
        ...
        { id: "f-seg-2", title: "Transcript count QC filters", type: "code",
        ...
        { id: "f-seg-3", title: "CPS proxy scoring (6 modules)", type: "code",
        ...
        { id: "f-seg-4", title: "Ghost cell detection", type: "code",
...

    {
      ...
      steps: [
        { id: "f-ct-1", title: "CONCORD integration (cross-sample)", type: "code",
        ...
        { id: "f-ct-2", title: "Cell type clustering and annotation", type: "code",
        ...
        { id: "f-ct-3", title: "Subclustering per major cell type", type: "code",
        ...
        { id: "f-ct-4", title: "Cell type composition across regions & disease", type: "figure",
...

    {
      ...
      steps: [
        { id: "f-sd-1", title: "BANKSY spatial clustering", type: "code",
        ...
        { id: "f-sd-2", title: "Disease-emergent spatial domain (DESD) detection", type: "code",
          ...
          xp: 12, cognitive_type: "deep", compute_lead_hrs: 12, estimated_blocks: 2 },
        { id: "f-sd-3", title: "Laminar integrity score", type: "code",
        ...
        { id: "f-sd-4", title: "Spatial domain marker genes", type: "figure",
  ...
  fic: [
    {
      ...
      steps: [
        ...
        { id: "fic-sd-2", title: "BANKSY spatial clustering (FIC)", type: "code", desc: "Run BANKSY on FIC samples. Disease-emergent spatial domain detection — compare to DLPFC. Do the same DESDs appear? FIC-specific DESDs?", checklist: ["BANKSY run on FIC samples","DESDs identified","FIC vs. DLPFC DESD comparison","FIC-specific DESDs annotated"], xp: 15, estimated_blocks: 3 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "fic-w-1", title: "All FIC figures finalized", type: "figure", desc: "FIC-specific figures: laminar map, VEN depletion, FIC DEG, convergent target list. Nature-ready.", checklist: ["VEN depletion figure (density plot + spatial)","FIC vs DLPFC Venn of convergent targets","FIC DESD spatial map","All figures pass statistical checklist"], xp: 10, estimated_blocks: 4 },
        { id: "fic-w-2", title: "FIC manuscript draft", type: "writing", desc: "Full FIC manuscript with emphasis on agranular cortex biology and treatment target convergence with DLPFC.", checklist: ["Introduction covers FIC biology (agranular, VENs, bvFTD)","Methods: reproducible","Results: VEN depletion + convergent targets as key findings","Discussion: therapeutic implications of convergent targets"], xp: 15, estimated_blocks: 6 },
        { id: "fic-w-3", title: "Advisor review + submission", type: "writing", desc: "Advisor review, revision, submission.", checklist: ["Advisor approved","Statistical checklist final pass","Zenodo DOI","Submitted"], xp: 5, estimated_blocks: 2 },
      ],
  ...
  bd2: [
    {
      ...
      steps: [
        ...
        { id: "bd2-qc-2", title: "BD2 decoding QC & FDR threshold", type: "code", desc: "Run same FDR sweep as DLPFC. Confirm decode yield is comparable. Flag any outlier samples.", checklist: ["FDR sweep run on ACC data","Decode yield per sample plotted","Outlier samples flagged (>2 SD below mean)","Threshold finalized"], xp: 8, estimated_blocks: 2 },
        { id: "bd2-qc-3", title: "Cell segmentation & QC (ACC)", type: "code", desc: "Run segmentation pipeline on ACC. Confirm expected cell density. Ghost cell detection. CPS proxy scoring adapted for BD (no Braak stage — use PANSS proxy if available).", checklist: ["Segmentation run","Expected cell density range confirmed","Ghost cells flagged","Notes: no Braak stage for BD — document alternative severity metric"], xp: 5, estimated_blocks: 2 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "bd2-sp-1", title: "BANKSY spatial clustering (ACC)", type: "code", desc: "Run BANKSY on ACC samples. Identify: (1) layer-preserving domains, (2) disease-emergent domains in BD vs CN.", checklist: ["BANKSY run","Domains compared: BD-I vs BD-II vs Control","L5a VEN layer domain integrity scored","Disease-emergent domains (if any) annotated"], xp: 15, estimated_blocks: 3 },
        { id: "bd2-sp-2", title: "Spatial coherence of BD molecular changes", type: "code", desc: "Are BD DE genes spatially coherent (Moran’s I)? Do they cluster in specific domains? This links molecular changes to spatial context.", checklist: ["Moran’s I computed for top BD DE genes","Spatial coherence compared BD vs CN","Genes with high spatial coherence prioritized for discussion"], xp: 10, estimated_blocks: 2 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "bd2-w-1", title: "All BD2 figures finalized", type: "figure", desc: "BD2 main figures: cell type composition (BD-I vs BD-II vs CN), top DE pathways, spatial domain map, VEN density in ACC.", checklist: ["All figures Nature-ready","BD-I vs BD-II comparison prominently shown","Medication confound addressed in figure or supplement"], xp: 10, estimated_blocks: 4 },
        { id: "bd2-w-2", title: "BD2 manuscript draft", type: "writing", desc: "Full manuscript. Introduction emphasizes: why single-cell spatial in BD? Why BD-I vs BD-II? Methods: medication confound plan. Results: 3-4 key findings.", checklist: ["Introduction cites BD spatial transcriptomics gap","BD-I vs BD-II framing clear","Cannabinoid/stress pathways discussed with cited literature","Limitations: medication confound, sample size"], xp: 15, estimated_blocks: 6 },
        { id: "bd2-w-3", title: "Advisor review + submission", type: "writing", desc: "Advisor review, revision, submission.", checklist: ["Advisor approved","Statistical checklist final pass","Submitted"], xp: 5, estimated_blocks: 2 },
      ],
  ...
  dg: [
    ...
    },
    {
      ...
      steps: [
        { id: "dg-ct-1", title: "DG cell type annotation", type: "code", desc: "Annotate DG cell types. Key: distinguish granule cells (PROX1+, CALB1+), mossy cells (hilus, CALB2+, SLC17A7+), CA3 pyramidal (KCNQ5+), newborn granule cells (DCX+, PROX1-low). Microglia, astrocytes standard.", checklist: ["All major DG cell types annotated","Newborn granule cells separated from mature GCs","Mossy cells identified in hilus","Proportions per sample reported"], xp: 15, estimated_blocks: 3 },
        { id: "dg-ct-2", title: "Disease-associated cell type changes (DG)", type: "code", desc: "LMM per cell type: fraction ~ disease + age + PMI + (1|donor). Key hypotheses: (1) newborn granule cell loss in AD, (2) mossy cell loss (hippocampal sclerosis), (3) microglial DAM enrichment in DG in AD.", checklist: ["LMM run for all DG cell types","Newborn GC fraction tested","Mossy cell fraction tested","Microglial state (DAM score) in DG tested"], xp: 15, estimated_blocks: 3 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "dg-w-1", title: "All DG figures finalized", type: "figure", desc: "DG main figures: neurogenesis score spatial map, DCX+ density per disease group, cell type census, maturation trajectory.", checklist: ["Neurogenesis spatial map (SGZ highlighted)","DCX+ density: AD vs CN","Maturation trajectory","All figures pass statistical checklist"], xp: 10, estimated_blocks: 4 },
        { id: "dg-w-2", title: "DG manuscript draft", type: "writing", desc: "Full manuscript. Introduction: address the Sorrells vs Boldrini controversy head-on. State your hypothesis before showing data. Methods: LATE confound handling. Results: spatial + transcriptomic + wet lab converge.", checklist: ["Introduction: Sorrells 2018 + Boldrini 2018 framed","LATE confound handling in Methods","Three lines of evidence converge (spatial + transcriptomic + IF)","Limitations: sample size, PMI"], xp: 15, estimated_blocks: 6 },
        { id: "dg-w-3", title: "Advisor review + submission", type: "writing", desc: "Advisor review, revision, submission.", checklist: ["Advisor approved","Sorrells/Boldrini controversy framing approved","Submitted"], xp: 5, estimated_blocks: 2 },
      ],
  ...
  eef2: [
    {
      ...
      steps: [
        { id: "m-eef2-1", title: "Efficiency regression model (OLS)", type: "code",
        ...
        { id: "m-eef2-2", title: "Permutation test (shuffle cell type labels)", type: "code",
          ...
          xp: 10, cognitive_type: "deep", compute_lead_hrs: 6, estimated_blocks: 2 },
        { id: "m-eef2-3", title: "Cross-region and cross-cohort stability", type: "code",
          ...
          xp: 10, cognitive_type: "deep", estimated_blocks: 2 },
        { id: "m-eef2-4", title: "Impact on downstream DE (artifact genes)", type: "code",
          ...
          xp: 15, cognitive_type: "deep", estimated_blocks: 2 },
        { id: "m-eef2-5", title: "smFISH wet lab validation", type: "wetlab",
    ...
    },
    {
      ...
      steps: [
        { id: "m-sub-1", title: "Subtype classification (AD1/AD2/AD3)", type: "code", desc: "Use CONCORD latent space to classify AD samples into transcriptomic subtypes. Reference: Mathys 2023 subtype signatures. Validate with Murray neuropathological subtype data from metadata.", checklist: ["Subtype classifier trained on published signatures","Samples classified with confidence score","Murray subtype correlation computed","Subtype assignments validated against clinical metadata"], xp: 15, cognitive_type: "deep", estimated_blocks: 6 },
        { id: "m-sub-2", title: "LATE TDP-43 DG/HC confound analysis", type: "code", desc: "In DG/HC region: test whether TARDBP expression pattern suggests LATE co-pathology. LATE creates a TDP-43-positive subpopulation that confounds AD vs. CN comparison in DG. Flag affected samples.", checklist: ["TARDBP expression in DG/HC neurons tested","LATE-suspect samples identified","DG/HC analysis run with and without LATE-suspect samples","Results reported separately: LATE-confounded vs. clean"], xp: 12, cognitive_type: "deep", estimated_blocks: 4 },
        { id: "m-sub-3", title: "Subtype-stratified analyses", type: "code", desc: "Repeat key analyses (DEG, CPS, spatial domains) stratified by AD subtype. Do subtypes show different spatial signatures?", checklist: ["All major analyses run per subtype","Subtype-specific DE genes identified","Pattern/Interpretation table per subtype","Figure: spatial domain composition per subtype"], xp: 8, cognitive_type: "deep", estimated_blocks: 3 },
      ],
  ...
  package: [
    {
      ...
      steps: [
        { id: "pkg-s-1", title: "Repo scaffold", type: "code", desc: "Create txomics/ with pyproject.toml, src/txomics/__init__.py, tests/, docs/, .github/workflows/ci.yml. See P0_scaffold_and_infrastructure.md for exact structure.", checklist: ["pyproject.toml with all dependencies","GitHub Actions CI runs pytest on push","pre-commit hooks: black, ruff, mypy","Docs: MkDocs or Sphinx scaffold"], xp: 8, cognitive_type: "deep", estimated_blocks: 3 },
        { id: "pkg-s-2", title: "FigureStyle class", type: "code", desc: "txomics/plotting/figure_style.py: FigureStyle class with apply(), remove_chartjunk(), nature_width(), scale_bar() methods. Encodes all Nature journal figure conventions.", checklist: ["FigureStyle class implemented","nature_width(column='single') returns 88mm","Wong 8-color categorical palette as default","scale_bar() adds 50µm scale bar to spatial plots","Unit test: apply FigureStyle to a test figure, check output"], xp: 8, cognitive_type: "deep", estimated_blocks: 3 },
        { id: "pkg-s-3", title: "pip install txomics works", type: "code", desc: "Final check: fresh venv, pip install from GitHub, import txomics, run txomics.hello() or similar smoke test.", checklist: ["pip install succeeds in clean venv","import txomics works","At least one function runs without error","Package pushed to GitHub (PUBLIC)"], xp: 4, cognitive_type: "deep", estimated_blocks: 2 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "pkg-co-1", title: "CONCORD integration wrapper", type: "code", desc: "txomics.integration.run_concord(adata, batch_key, latent_dim) wraps CONCORD. Returns adata with X_concord in obsm. Efficiency batch handling documented.", checklist: ["Function runs on real data","LISI score computation included","Efficiency batch variable documented in tutorial"], xp: 10, cognitive_type: "deep", estimated_blocks: 4 },
        { id: "pkg-co-2", title: "SAE implementation", type: "code", desc: "txomics.interpretability.SparseAutoencoder(n_latent, n_features, lambda_l1). PyTorch implementation. Feature stability test included.", checklist: ["PyTorch dependency documented","Training loop with loss tracking","Feature interpretation helper: top_cells_per_feature()"], xp: 10, cognitive_type: "deep", estimated_blocks: 4 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "pkg-n-1", title: "Spatial graph builder", type: "code", desc: "txomics.network.build_spatial_graph(adata, method='knn', k=10) returns NetworkX graph or AnnData.obsp sparse matrix.", checklist: ["kNN and Delaunay options","Distance in µm","Symmetric adjacency matrix stored in obsp"], xp: 7, cognitive_type: "deep", estimated_blocks: 3 },
        { id: "pkg-n-2", title: "Assortativity + SIR", type: "code", desc: "txomics.network.assortativity(graph, node_attr) returns r. txomics.network.sir_model(adata, ...) returns R0, beta, gamma per sample.", checklist: ["Assortativity matches NetworkX reference","SIR returns R0 with CI","Both have unit tests"], xp: 8, cognitive_type: "deep", estimated_blocks: 3 },
        { id: "pkg-n-3", title: "Custom LR kernel", type: "code", desc: "txomics.network.lr_kernel(adata, lr_pairs, lambda_um=50) returns interaction score matrix.", checklist: ["lambda parameter in µm","LR pairs from CellChatDB loadable","Performance: < 60s for 50k cells × 200 LR pairs"], xp: 5, cognitive_type: "deep", estimated_blocks: 2 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "pkg-db-1", title: "Efficiency Explorer dashboard", type: "code", desc: "Interactive: select cell type → see efficiency distribution. Quarto + Plotly. Data: pre-computed efficiency stats per cell type.", checklist: ["Dashboard loads in < 3s","Cell type selector works","Efficiency violin updates dynamically","Deployed to GitPages"], xp: 5, cognitive_type: "deep", estimated_blocks: 2 },
        { id: "pkg-db-2", title: "Spatial Domain Browser", type: "code", desc: "Interactive tissue viewer: pan/zoom, color by domain/cell type/gene expression. Most useful dashboard — justify every widget.", checklist: ["Pan/zoom functional","Gene expression color toggle works","Domain label overlay toggleable","Data: efficient format (parquet/DuckDB, not full HDF5)"], xp: 8, cognitive_type: "deep", estimated_blocks: 3 },
        { id: "pkg-db-3", title: "CONCORD Embedding Explorer + DE Browser + CPS Map", type: "code", desc: "Three additional dashboards: (1) UMAP with cell type/disease/gene toggle, (2) DE gene browser with spatial plot linked, (3) CPS proxy spatial heatmap.", checklist: ["All 3 deployed to GitPages","Linked brushing between UMAP and spatial view (DE Browser)","CPS map shows slider for disease group filter"], xp: 12, cognitive_type: "deep", estimated_blocks: 4 },
      ],
  ...
  career: [
    {
      ...
      steps: [
        ...
        { id: "car-t-2", title: "Chapter 1 draft submitted", type: "writing", desc: "Write Chapter 1 based on flagship paper manuscript. Use BIO_BACKGROUND.md for introduction.", checklist: ["Draft submitted to advisor","Biological context from BIO_BACKGROUND.md integrated","Methods section references txomics package","All main figures included"], xp: 35, cognitive_type: "deep", estimated_blocks: 6 },
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        { id: "car-g-2", title: "ad_seqfish_analysis repo: private on GitHub", type: "code", desc: "Initialize analysis repo, push to GitHub as PRIVATE. Document dependencies on txomics.", checklist: ["Private repo created","All analysis notebooks committed","Requirements.txt or pyproject.toml complete","README: 'this repo uses txomics v0.x.x'"], xp: 7, cognitive_type: "deep", estimated_blocks: 3 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "car-pre-1", title: "Paper manuscript complete (EEF2 or Assortativity)", type: "writing", desc: "Full manuscript: title, abstract, intro, methods, results, discussion, figures (Nature format). All robustness gates passed.", checklist: ["All robustness gates passed","Statistical checklist completed","Figures: Nature-ready","Advisor has reviewed and approved for submission"], xp: 25, cognitive_type: "deep", estimated_blocks: 6 },
        { id: "car-pre-2", title: "bioRxiv submission", type: "writing", desc: "Submit to bioRxiv. Post on Twitter/X and LinkedIn. Email to 3 people who might cite it.", checklist: ["bioRxiv submission completed","DOI obtained","Announced on social media","Code and data on Zenodo"], xp: 15, cognitive_type: "deep", estimated_blocks: 6 },
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        { id: "car-d-2", title: "Defense presentation", type: "writing", desc: "45-minute presentation + Q&A. Practice with lab 2× before. Prepare for hardest questions from robustness_and_validation.md universal critiques.", checklist: ["2 practice talks done","Answers to top 10 reviewer critiques prepared","Slides reviewed by advisor"], xp: 30, cognitive_type: "deep", estimated_blocks: 6 },
        { id: "car-d-3", title: "Defense passed + revisions submitted", type: "writing", desc: "Defense passed. Committee revisions (if any) completed and submitted. Degree conferred.", checklist: ["Defense passed","All revisions completed","Degree conferred by Caltech Registrar"], xp: 20, cognitive_type: "deep", estimated_blocks: 6 },
      ],
    ...
    },
    {
      ...
      steps: [
        { id: "car-tx-1", title: "v1.0 release on PyPI", type: "code", desc: "Final documentation pass, tests at >80% coverage, version 1.0.0 released on PyPI.", checklist: ["All public functions documented","Test coverage > 80%","pip install txomics works from PyPI","CHANGELOG.md written"], xp: 15, cognitive_type: "deep", estimated_blocks: 6 },
        { id: "car-tx-2", title: "Announcement + usage in paper Methods", type: "writing", desc: "Announce on Twitter/X. GitPages site live with interactive demo. Cited in flagship paper Methods as 'analyses performed using txomics (github.com/rahma/txomics)'.", checklist: ["Announcement posted","GitPages site live","Cited in flagship paper Methods section"], xp: 10, cognitive_type: "deep", estimated_blocks: 4 },
      ],
